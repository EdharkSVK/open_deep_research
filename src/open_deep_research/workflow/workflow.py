...
async def clarify_with_user(state: ReportState, config: RunnableConfig):
    ...
    writer_model = init_chat_model(
        model=writer_model_name, model_provider="groq", model_kwargs=writer_model_kwargs
    )
    ...
    return {
        "messages": [AIMessage(content=results.question)],
...
async def generate_report_plan(
    ...
    planner_llm = init_chat_model(
        model=planner_model, model_provider="groq", model_kwargs=planner_model_kwargs
    )
