...
class WorkflowConfiguration:
    ...
    summarization_model: str = "qwen3-8b-32768"
    ...
    planner_model: str = "qwen3-8b-32768"
    planner_model_kwargs: Optional[Dict[str, Any]] = None
    writer_provider: str = "groq"
    writer_model: str = "qwen3-8b-32768"
...
class MultiAgentConfiguration:
    ...
    supervisor_model: str = "qwen3-8b-32768"
    researcher_model: str = "qwen3-8b-32768"
